...
public class Board {
    ...
    public void initializeBoard(Player player1, Player player2) {
        ...
        Rook rook1 = new Rook(Color.BLACK, 0, 0);
        Rook rook2 = new Rook(Color.BLACK, 0, 7);
        Bishop bishop1 = new Bishop(Color.BLACK, 0, 1);
        Bishop bishop2 = new Bishop(Color.BLACK, 0, 6);
        Knight knight1 = new Knight(Color.BLACK, 0, 2);
        ...
        rook2 = new Rook(Color.WHITE, 7, 7);
        bishop1 = new Bishop(Color.WHITE, 7, 1);
        bishop2 = new Bishop(Color.WHITE,7, 6);
        knight1 = new Knight(Color.WHITE, 7, 2);
    ...
    public void move(Player player, Tile fromTile, Tile toTile) {
        ...
        if(movedPiece.isMoveValid(toTile)){
